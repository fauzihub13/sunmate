...
class _$GetAllNotificationImpl implements _GetAllNotification {
  ...
  @override
  String toString() {
    return 'NotificationEvent.getAllNotification()';
  }
...
mixin _$NotificationState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Notification> notification) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Notification> notification)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Notification> notification});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Notification> notification)
...
abstract class _Loaded implements NotificationState {
  const factory _Loaded(final List<Notification> notification) = _$LoadedImpl;
