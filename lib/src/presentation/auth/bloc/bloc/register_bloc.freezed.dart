...
class _$RegisterImpl implements _Register {
  ...
  @override
  String toString() {
    return 'RegisterEvent.register(name: $name, phoneNumber: $phoneNumber, email: $email, password: $password, passwordConfirmation: $passwordConfirmation)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, phoneNumber, email, password, passwordConfirmation);
  ...
  TResult when<TResult extends Object?>({
    ...
    return register(name, phoneNumber, email, password, passwordConfirmation);
  }
