...
// in flutter_sunmate/test/auth_remote_datasources_test.dart.
...
/// A class which mocks [AuthLocalDatasources].
///
/// See the documentation for Mockito's code generation for more information.
class MockAuthLocalDatasources extends _i1.Mock
    implements _i8.AuthLocalDatasources {
  MockAuthLocalDatasources() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> saveAuthData(_i3.AuthResponseModel? authReponseModel) =>
      (super.noSuchMethod(
        Invocation.method(
          #saveAuthData,
          [authReponseModel],
  ...
  @override
  _i4.Future<_i3.AuthResponseModel> getAuthData() => (super.noSuchMethod(
        Invocation.method(
          #getAuthData,
          [],
        ),
        returnValue:
            _i4.Future<_i3.AuthResponseModel>.value(_FakeAuthResponseModel_2(
          this,
          Invocation.method(
            #getAuthData,
            [],
      ...
      ) as _i4.Future<_i3.AuthResponseModel>);

  @override
  _i4.Future<bool> isAuthDataExist() => (super.noSuchMethod(
        Invocation.method(
          #isAuthDataExist,
          [],
        ),
